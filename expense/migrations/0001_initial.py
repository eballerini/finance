# Generated by Django 3.0 on 2020-05-24 15:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('minimum_spending', models.IntegerField(blank=True, null=True)),
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='expense.Account')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='expense.Account')),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='expense.Category')),
                ('credit_card', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='expense.CreditCard')),
            ],
        ),
    ]
